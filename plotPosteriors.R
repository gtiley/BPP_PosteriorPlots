...
x1 <- read.table("1/mcmc.txt",header=TRUE,sep="\t")
x2 <- read.table("2/mcmc.txt",header=TRUE,sep="\t")
x3 <- read.table("3/mcmc.txt",header=TRUE,sep="\t")
x4 <- read.table("4/mcmc.txt",header=TRUE,sep="\t")
